...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        MemoryManager memoryManagerToTest = new MemoryManager(MemoryManager.MemoryStrategy.WORST_FIT);
        ...
        test.basicTestOn("../Data/WORST_FIT.csv");
        // test.basicTestOn("../Data/BEST_FIT.csv");
        // test.basicTestOn("../Data/ERRONEOUS_ALLOCATION_BEST_FIT.csv");
        // test.basicTestOn("../Data/FIRST_FIT.csv");

        // test.basicTestOn("../Data/FIRST_FIT(2).csv");
        // test.basicTestOn("../Data/BEST_FIT(2).csv");
        // test.basicTestOn("ERRONEOUS_ALLOCATION_BEST_FIT(2).csv");
        // test.basicTestOn("../Data/WORST_FIT(2).csv");
