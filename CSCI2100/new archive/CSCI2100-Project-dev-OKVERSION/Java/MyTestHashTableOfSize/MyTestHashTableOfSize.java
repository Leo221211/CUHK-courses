package MyTestHashTableOfSize;

import java.math.BigInteger;
import java.util.Scanner;

import csci2100.HashTableOfAddr;

class HashTableOfSize {
    /**
...
public class MyTestHashTableOfSize {
    public static void main(String[] args) {
        HashTableOfSize table = new HashTableOfSize();
