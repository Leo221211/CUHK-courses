...
public class HashTableOfSize {
    ...
    /**
     * the max size of free and allocated nodes
     */
    // private BigInteger freeMaxSize; // don't need alloc max size, need to update if there is new put or delete

    /**
     * size related parameters
     */
    // private final BigInteger SIZE_1GB = new BigInteger("1073741824");  // 1024^3
    // private final BigInteger TOTAL_SIZE;
     ...
     */
    public HashTableOfSize(/*BigInteger totalSize, MemMapNode wholeFreeNode*/) {
        // Create a hash table with an initial size of 64.
        htArray = new HTNode[MIN_HTARRY_SIZE];
        // eleNum = 0;
        // TOTAL_SIZE = totalSize;

        // // insert the whole free block
        // this.put(TOTAL_SIZE, wholeFreeNode);

        // // update max
        // freeMaxSize = TOTAL_SIZE;
    }
     ...
     * modified need both key and value be the same
     */
