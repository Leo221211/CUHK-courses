package MyTestHashTableOfAddr;

import java.math.BigInteger;
import java.util.Scanner;
import java.util.function.BiConsumer;

class HashTableOfAddr {
    /**
     ...
     * assume no pair with same key (if with the same key, there will be 2 elements with the same key)
     */
...
public class MyTestHashTableOfAddr {
    public static void main(String[] args) {
        HashTableOfAddr table = new HashTableOfAddr();
