...
public class MemoryManager {
    ...
    public MemoryManager(MemoryStrategy strategy) {
        // Debug.dbgPrint("total bytes: " + TOTAL_BYTES);
    ...
    public int request(MemoryOperation op) {
        ...
        if (op.getAddr() == null) {
            ...
            switch (strategy) {
                ...
                case BEST_FIT:
                    ...
                    // Debug.dbgPrint("is occupied? " + toInsert.isOccupied + "starting a");
                    // until is a free block
                    // while(toInsert.isOccupied) {
                    //     toInsert = 
                    // }
        ...
        //// update in memMap
        // Debug.dbgPrint("op.getAddr()" + op.getAddr());  // wrong: changed
