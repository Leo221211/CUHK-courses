...
from asgn_3_package.pokeman import Pokeman, PokemanTrainingData
...
class PokemanGym(TrainingStatusObserver):
    ...
    def finished_training(self, obj: Trainable):
        ...
        training_data = PokemanTrainingData()
        training_data.level = new_level
        training_data.hp = new_level * 10
        training_data.attack = new_level * 5
        training_data.defense = new_level * 5
        training_data.sped = new_level * 5
