...
from asgn_3_package.training import Trainable, TrainingStatusObserver, TrainingData
...
class Pokeman(Trainable):
    ...
    def update_stats(self, training_data: TrainingData):
        ...
        self._level = training_data.get_attribute_value("level")
        self._hp = training_data.get_attribute_value("hp")
        self._attack = training_data.get_attribute_value("attack")
        self._defense = training_data.get_attribute_value("defense")
        self._speed = training_data.get_attribute_value("speed")
