...
class PokemanGym(TrainingStatusObserver):
    ...
    def finished_training(self, obj: Trainable):
        ...
        stats_obj = PokemanTrainingStats()
        stats_obj.level = new_level
        stats_obj.hp = new_level * 10
        stats_obj.attack = new_level * 5
        stats_obj.defense = new_level * 5
        stats_obj.speed = new_level * 5

        obj.update_stats(stats_obj)
